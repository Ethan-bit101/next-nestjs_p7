...
interface JwtPayload {
  ...
  return (
    <div>   <div className="shadow-xl border flex p-1 items-center justify-between fixed bg-white top-0 left-0 right-0 z-50">
     ...
     <div className = "float-right relative top-20 left-4 w-94 mr-20">
   ...
   <main className="ml-[65px] mt-10 float-left">

      <fieldset className = "relative bottom-[-30px]">
        <figure>

      <iframe width="980" height="500" src="https://www.youtube.com/embed/FXozwCdSLb0?si=an7-5KkcQwzxp9nT" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      <figcaption className = "border pt-3">
